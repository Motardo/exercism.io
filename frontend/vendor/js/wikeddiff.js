...
var WikEdDiff = function () {
	...
	this.config = {
		...
		'stylesheet':
			...
			// Insert
			'.wikEdDiffInsert {' +
			'font-weight: bold; background-color: #dbffdb; ' +
			'color: #222; border-radius: 0.25em; padding: 0.2em 1px; ' +
			'} ' +
			'.wikEdDiffInsertBlank { background-color: #eaffea; } ' +
			'.wikEdDiffFragment:hover .wikEdDiffInsertBlank { background-color: #dbffdb; } ' +

			// Delete
			'.wikEdDiffDelete {' +
			'font-weight: bold; background-color: #ffdbdb; ' +
			'color: #222; border-radius: 0.25em; padding: 0.2em 1px; ' +
			'} ' +
			'.wikEdDiffDeleteBlank { background-color: #ffeaea; } ' +
			'.wikEdDiffFragment:hover .wikEdDiffDeleteBlank { background-color: #ffdbdb; } ' +
